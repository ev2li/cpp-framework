...
HttpRequsetParser::HttpRequsetParser(){
...
size_t HttpRequsetParser::execute(const char* data, size_t len, size_t off){

    return 0;
}

int HttpRequsetParser::isFinished() const{

    return 0;
}

int HttpRequsetParser::hasError() const{
...
void on_response_path(void *data, const char *at, size_t length){
